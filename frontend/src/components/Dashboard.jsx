  ...
  return (
    <Layout>
      <div className="mb-8 bg">
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="text-gray-500">08 October, Sunday</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <FinancialCard title="Total Balance" amount="NGN 10,345.89" change={30} />
        <FinancialCard title="Monthly Income" amount="NGN 10,345.89" change={30} />
        <FinancialCard title="Monthly Expense" amount="NGN 10,345.89" change={30} />
        <Card className="bg-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-500">Budget Alert</CardTitle>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="h-4 w-4 text-yellow-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Budgets
            icon={<div className="bg-blue-100 rounded-full p-2">
              <svg className="w-6 h-6 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 0 012 2v10m-6 0a2 2 0 002 2h2a2 0 002-2m0 0V5a2 2 0 012-2h2a2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
            </div>}
            title="Food"
            amount="2,000"
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <Button variant="outline" className="text-blue-600 border-blue-600">Add New</Button>
          </div>
