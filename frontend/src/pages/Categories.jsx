...
export default function CategoriesPage() {
    ...
    const handleDeleteCategory = async (category) => {
        setIsDeleting(true);
        try {
            await categoryEndpoint.deleteCategory(category.id);
            setCategories((prevCategories) =>
                        ...
                        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                            <div className="bg-white p-6 rounded-lg shadow-lg">
                                ...
                                <div className="flex justify-end">
                                    <Button className="mr-2" onClick={() => setConfirmDelete(null)}>Cancel</Button>
                                    <Button className="bg-red-500 hover:bg-red-600 text-white" onClick={() => handleDeleteCategory(confirmDelete)} disabled={isDeleting}>
